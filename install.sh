...
if [  -n "$(uname -a | grep Ubuntu)" ]; then
	...
	sudo apt-get update
        ...
        apt-get --assume-yes install php7.4-imap php7.4-suhosin php7.4-intl php7.4-cli php7.4-json php7.4-common php7.4-mysql php7.4-zip php7.4-gd php7.4-mbstring php7.4-curl php7.4-xml php7.4-bcmath
